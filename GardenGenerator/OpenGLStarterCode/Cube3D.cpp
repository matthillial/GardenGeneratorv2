...
int main(int argc, char *argv[]){
  ...
  SDL_Window* window = SDL_CreateWindow(window_title, 500, 500, 800, 600, SDL_WINDOW_OPENGL);
  ...
  float lineVertices[] = {
	 -0.5f, 0.0f, 0.f, 0.5f, 0.27f, 0.07f, 0.f, 0.f,
	 0.5f , 1.0f, 0.f, 0.5f, 0.27f, 0.07f, 1.f, 1.f,
	-0.5f , 1.0f, 0.f,  0.5f, 0.27f, 0.07f, 0.f, 1.f,
	-0.5f , 0.0f, 0.f, 0.5f, 0.27f, 0.07f, 0.f, 0.f,
	 0.5f , 0.0f, 0.f, 0.5f, 0.27f, 0.07f, 1.f, 0.f,
	 0.5f , 1.0f, 0.f, 0.5f, 0.27f, 0.07f, 1.f, 1.f
  };
  ...
  glBufferData(GL_ARRAY_BUFFER, sizeof(lineVertices), lineVertices, GL_STATIC_DRAW); //upload vertices to vbo
...
void Win2PPM(int width, int height){
    ...
    /* Open the file */
    sprintf_s(fname,"%simage_%04d.ppm",outdir,counter);
